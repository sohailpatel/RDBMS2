...
create procedure displaycost() begin select productid,total_sell as Total_Revenew_Earned,total_quantity as Toal_Products_Sold from display where id=0;end;//
...
open pr; 
curloop:loop fetch from pr into tpr;
leave curloop;close pr;
end loop curloop;end block2;  
open cost_cur;  
cursorfetch:loop  
